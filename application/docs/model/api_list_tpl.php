...
<body>
  ...
  <div class="ui fixed inverted menu">
    <div class="ui container">
      <a href="/tpdoc/public/index.php/docs/docs/index" class="header item">
...
<div class="ui text container" style="max-width: none !important; width: 1200px" id="menu_top">
    <div class="ui floating message">
                ...
                foreach ($subAllApiS as $key => $item) {
                    ...
                    <?php
                            if (!$env) {
                                ...
                                if ($theme == 'fold') {
                                    echo '<div style="float: right"><a href="' . $curUrl . '/docs/docs/index?type=expand">切换回展开版</a></div>';
                                } else {
                                    echo '<div style="float: right"><a href="' . $curUrl . '/docs/docs/index?type=fold">切换回折叠版</a></div>';
                                }
                            }
                    ?>
                    </div>
        ...
        <p>&copy; Powered  By <a href="#">井梅</a> <span id="version_update"></span> <p>
    </div>
    </div>
</div>
